...
export default function EventHero({ event }: EventHeroProps) {
  ...
  return (
    <div className="relative w-full">
      {/* Hero Banner Section - Full width with increased height */}
      <div className="relative w-full h-[320px] md:h-[420px] lg:h-[380px] overflow-hidden">
        {heroBannersLoading ? (
          // Loading skeleton
      ...
      {/* Main Card - Full width container with centered content */}
      <div className="relative w-full">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-md flex flex-col md:flex-row -mt-16 md:-mt-20 lg:-mt-24 overflow-hidden">
            {/* Slider Section */}
            <div className="md:w-2/3 w-full h-[240px] sm:h-[300px] md:h-[340px] lg:h-[300px] relative">
