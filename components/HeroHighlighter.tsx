...
function ShowOpeningCountdown({ startDateIso }: { startDateIso: string }) {
  ...
  return (
    <div
      className="absolute top-4 right-[25%] translate-x-[50%] z-[2] bg-gray-900/90 backdrop-blur-sm text-white px-3 py-1.5 shadow-lg border border-gray-700"
      role="timer"
      aria-live="polite"
    ...
    >
      ...
      <div className="flex items-stretch gap-1.5 sm:gap-2">
        {units.map(({ value, label }) => (
          <div
            key={label}
            className="flex min-w-0 flex-1 flex-col items-center justify-center bg-black/50 px-1.5 py-1  border border-gray-700"
          >
